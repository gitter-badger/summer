...
<html>
	<head>
		...
		<script type="text/javascript" src="static/js/common/coder.js"></script>
		<script type="text/javascript" src="static/js/common/coder-common.js"></script>
	...
	<body>
		<div id="page">
            ...
            <div id="top">
            	<div id="logo"></div>
            	<div id="top_title"> Code Manager</div>
            	<div id="top_info">
